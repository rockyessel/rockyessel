...
import { CHROME_EXECUTABLE_DEV, CHROME_EXECUTABLE_PROD } from '@/lib/config/env';

const CHROME_EXECUTABLE_PATH = isProduction ? CHROME_EXECUTABLE_PROD : CHROME_EXECUTABLE_DEV;
