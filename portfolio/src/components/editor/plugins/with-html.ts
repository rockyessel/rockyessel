...
// Helper function to enforce NodeText structure
const enforceNodeText = (children: NodeText[]): NodeText[] => {
  return children.map((child) => {
    // TODO: Add more specific enforcement logic for NodeText later
    const enforcedChild: NodeText = {
      ...child,
      text: child.text || "",
    };
    return enforcedChild;
  });
};
