...
const PrivacyPolicy = () => {
  ...
  return (
    <main className='max_screen:w-full max_screen:px-4 px-4 xl:w-[70rem] mx-auto'>
      <article className='prose-xl text-white'>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Rocky Essel.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Rocky Essel, accessible from{' '}
              <a
                href='https://esselr.vercel.app/'
                rel='external nofollow noopener'
                target={`_blank`}
              >
                https://esselr.vercel.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          advertising partners of Rocky Essel.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Rocky Essel, which are sent
        ...
        <p>
          Note that Rocky Essel has no access to or control over these cookies
        ...
        <p>
          Rocky Essel&apos;s Privacy Policy does not apply to other advertisers
        ...
        <ul>
          <li>
            <p>By email: essel_r@outllok.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{' '}
              <a
                href='https://esselr.vercel.app/contact'
                rel='external nofollow noopener'
                target={`_blank`}
              >
                https://esselr.vercel.app/contact
              </a>
            </p>
          </li>
        </ul>
