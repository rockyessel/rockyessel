...
const Modal: React.FC<ModalProps> = (props) => {
  ...
  const CommentModal = (
    <div className='py-12 text-slate-900 bg-slate-900 transition duration-150 bg-opacity-[0.5] overflow-hidden ease-in-out z-10 fixed top-1/2 -translate-x-1/2 w-[100%] h-[100%] -translate-y-1/2 left-1/2'>
